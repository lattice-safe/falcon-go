...
If you discover a security vulnerability in `falcon-go`, please report it
responsibly:
...
- **No external C dependencies** — pure Go implementation
- **Byte-for-byte parity** with the Rust `falcon-rs` reference
...
| Module | Purpose |
|--------|---------|
| `golang.org/x/crypto` | SHAKE256 (Keccak) for internal hashing |
